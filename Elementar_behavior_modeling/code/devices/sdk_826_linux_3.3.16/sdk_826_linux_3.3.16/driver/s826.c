 ...
 *
 *  Copyright (C) 2012-2024 Sensoray Co., Inc.  This program is free software;
...
#define S826_RELEASE		8
#define S826_VERSION		KERNEL_VERSION(S826_MAJOR_VERSION,	\
					       S826_MINOR_VERSION,	\
					       S826_RELEASE)
#define S826_VERSION_TEXT "Sensoray 826 driver, version 1.0.9"
...
static int __init s826_init(void)
{
	...
	if (s826_major < 0)
		return s826_major;
#if LINUX_VERSION_CODE < KERNEL_VERSION(6, 4, 0) && defined(HAVE_OLD_CLASS_DEVICE)
	s826_class = class_create(THIS_MODULE, "s826");
#else
	s826_class = class_create("s826");
#endif
